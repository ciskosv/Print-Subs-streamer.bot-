...
public class CPHInline
{
	...
	public bool Execute()
	{
		//Download the user profile picture and save it to the streamerbot directory
		//The file is deleted after printing
		String profilepic = args["targetUserProfileImageUrl"].ToString(); 
		
		using (WebClient webClient = new WebClient()){
			byte[] dataArr = webClient.DownloadData(profilepic);
			//save file to local
			File.WriteAllBytes(@"profile.png", dataArr);
		}
	...
	private void pd_PrintPage(object sender, PrintPageEventArgs ev)
    {
		...
		Image photo = Image.FromFile("profile.png");
		...
		line[9] = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.";
		////
